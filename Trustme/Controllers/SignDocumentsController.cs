...
namespace Trustme.Controllers
{
    ...
    public class SignDocumentsController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Sign(SignViewModel signViewModel)
        {

            if (signViewModel.PkFile == null)
            {
                TempData["PKNull"] = "You forgot to attach private key file!";
                return RedirectToAction("SignSentDocument", new { IdUnsignedDocument = signViewModel.IdUnsignedDocument });
            }
            string fileExtension = System.IO.Path.GetExtension(signViewModel.PkFile.FileName);
            ...
            UnsignedDocument unsignedDocument = _UnsignedDocumentRepository.GetUnsignedDocumentById(signViewModel.IdUnsignedDocument);
            ...
            //Sign document
            SignModel signModel = _Sign.SignDocumentTest(signViewModel.PkFile, documentFile, unsignedDocument.KeyId, HttpContext);
            ...
            return RedirectToAction("SignSentDocument", new { IdUnsignedDocument = signViewModel.IdUnsignedDocument, Signature = signature });
        }
